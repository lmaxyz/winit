...
pub struct WlShellSurfaceResize(Resize);

impl From<ResizeDirection> for WlShellSurfaceResize {
    fn from(value: ResizeDirection) -> Self {
        match value {
            ResizeDirection::East => WlShellSurfaceResize(Resize::Right),
            ResizeDirection::West => WlShellSurfaceResize(Resize::Left),
            ResizeDirection::North => WlShellSurfaceResize(Resize::Top),
            ResizeDirection::South => WlShellSurfaceResize(Resize::Bottom),
            ResizeDirection::NorthEast => WlShellSurfaceResize(Resize::TopRight),
            ResizeDirection::NorthWest => WlShellSurfaceResize(Resize::TopLeft),
            ResizeDirection::SouthEast => WlShellSurfaceResize(Resize::BottomRight),
            ResizeDirection::SouthWest => WlShellSurfaceResize(Resize::BottomLeft)
        }
    }
}

impl Into<Resize> for WlShellSurfaceResize {
    fn into(self) -> Resize {
        self.0
    }
}
