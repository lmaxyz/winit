...
pub trait WindowAttributesExtX11 {
    ...
    /// Window::attributes().with_base_size(LogicalSize::new(400.0, 200.0));
    ///
    /// // Or specify the size in physical dimensions like this:
    /// Window::attributes().with_base_size(PhysicalSize::new(400, 200));
    /// ```
    ...
    /// let window_attributes = Window::attributes().with_embed_parent_window(parent_window_id);
