...
impl Default for PlatformSpecificWindowAttributesAttributes {
    fn default() -> Self {
        Self {
            owner: None,
            menu: None,
...
unsafe impl Send for PlatformSpecificWindowAttributesAttributes {}
unsafe impl Sync for PlatformSpecificWindowAttributesAttributes {}
