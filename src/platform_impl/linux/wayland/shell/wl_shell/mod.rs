...
impl Dispatch<wl_shell::WlShell, GlobalData, WinitState> for WlShell {
    fn event(
...
delegate_dispatch!(WinitState: [ wl_shell_surface::WlShellSurface: GlobalData] => WlShell);
delegate_dispatch!(WinitState: [ wl_shell::WlShell: GlobalData] => WlShell);