...
use crate::{
    ...
    platform_impl::{self, PlatformSpecificWindowAttributesAttributes},
};
...
///     match event {
///         Event::Resumed => {
///             let window = event_loop.create_window(Window::attributes()).unwrap();
///             windows.push(window);
///         }
///         Event::WindowEvent {
...
pub struct WindowAttributes {
    ...
    #[allow(dead_code)]
    pub(crate) platform_specific: PlatformSpecificWindowAttributesAttributes,
}
...
impl WindowAttributes {
    ...
    #[inline]
    #[deprecated = "use `Window::attributes` instead"]
    pub fn new() -> Self {
        Default::default()
    }
}
